...
export const ALL_CLASSES: MapleClass[] = [
  ...
  { name: '아크메이지(얼,번)', type: 'mage', unionStats: ['INT', '마력', '방어율 무시'] },
  ...
  { name: '아크',         type: 'mage', unionStats: ['INT', '마력', '최대 MP'] },
  { name: '라라',         type: 'mage', unionStats: ['INT', '마력', '소환수 공격 데미지'] },
  { name: '카나',         type: 'mage', unionStats: ['INT', '최대 MP', '소환수 공격 데미지'] },
  { name: '린',           type: 'mage', unionStats: ['INT', '최대 MP', '마력'] },
  ...
  { name: '메르세데스',   type: 'archer', unionStats: ['LUK', '크리티컬 확률', '크리티컬 데미지'] },
  { name: '스트링어',     type: 'archer', unionStats: ['DEX', '공격력', '방어율 무시'] },

  // 도적
  { name: '나이트로드',   type: 'thief', unionStats: ['LUK', '크리티컬 확률', '크리티컬 데미지'] },
  { name: '섀도어',       type: 'thief', unionStats: ['LUK', '공격력', '보스 처치 시 획득 메소'] },
  { name: '듀얼블레이더', type: 'thief', unionStats: ['LUK', '크리티컬 확률', '공격력'] },
  { name: '팬텀',         type: 'thief', unionStats: ['LUK', '크리티컬 확률', '보스 처치 시 획득 메소'] },
  { name: '은월',         type: 'thief', unionStats: ['LUK', '공격력', '크리티컬 확률'] },
  { name: '호영',         type: 'thief', unionStats: ['LUK', '공격력', '크리티컬 데미지'] },
  { name: '카드',         type: 'thief', unionStats: ['LUK', '크리티컬 데미지', '공격력'] },

  // 해적
  { name: '바이퍼',       type: 'pirate', unionStats: ['STR', '공격력', '최대 HP'] },
  { name: '캐논슈터',     type: 'pirate', unionStats: ['STR', '최대 HP', '공격력'] },
  { name: '버키니어',     type: 'pirate', unionStats: ['STR', '공격력', '크리티컬 확률'] },
  { name: '썬더브레이커', type: 'pirate', unionStats: ['STR', '공격력', '크리티컬 데미지'] },
  ...
  { name: '호크아이',     type: 'pirate', unionStats: ['DEX', '공격력', '크리티컬 데미지'] },
]

export function findClass(name: string): MapleClass | undefined {
  return ALL_CLASSES.find(c => c.name === name)
    ?? ALL_CLASSES.find(c => name.includes(c.name) || c.name.includes(name))
}
